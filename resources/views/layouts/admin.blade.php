...
<html>
  ...
  <body style="background-image: url(/images/admin.jpg);">
    ...
    <nav class="w3-sidenav w3-collapse w3-white w3-card-2 w3-animate-left" id="mySidenav" style="background-image: url(/images/admin.jpg);">
      ...
      <a style="background-color:orange;" href="{{url('admin/rooms')}}" class="{{Request::is('admin/users') ? 'w3-grey' : ''}} w3-border w3-margin-top"><i class="fa fa-users" aria-hidden="true" ></i> Manage Rooms </a>
      <a style="background-color:orange;" href="{{url('admin/seatingsview')}}" class="{{Request::is('admin/vtypes') ? 'w3-grey' : ''}} w3-border w3-margin-top"><i class="fa fa-th-large" aria-hidden="true"></i> View seatings</a>
